...
•	cnffile (string): Path to the k-SAT CNF/DIMACS file (Line 16).
•	cnffile_new (string, optional): Path to save the 3-SAT reduced CNF file if needed. Default is an empty string ('') (Line 17).
•	digital_backup (integer, optional): (Line 20)
